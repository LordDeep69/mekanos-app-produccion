...
import { ClaseAislamientoEnum, NumeroFasesEnum, TipoArranqueEnum, TipoCombustibleEnum, TipoMotorEnum } from './create-equipo-motor.dto';

export class UpdateEquipoMotorDto {
  @IsOptional()
